...
namespace ProblemSet02
{
    class Program
    {
        public static String text = TextReader.ReadFile(@"D:\text.txt");
        ...
        static void Main(string[] args)
        {
            ...
            ex3.DeleteWordsWithLength(lenghtWord);
            ...
            ex4.ReplaceWord(0, lenghtWord, replaceWord);
            Console.WriteLine(ex4);

            Console.WriteLine("\nConcordance:");
            Text ourText = new Text(text);
            Console.WriteLine("Our TEXT: " + ourText);
            Console.WriteLine("\n___________________________");
            Dictionary<String, Concordance> resultHandling = ourText.GetStatistics();
            List<String> statsRecords = new List<String>();
            foreach (var word in resultHandling)
            {
